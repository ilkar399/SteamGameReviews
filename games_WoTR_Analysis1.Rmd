...
```{r, Loading-and-cleaning-up-datasets, results='hide', message=FALSE}
#Loading datasets
...
Let's take a look at how reviews (and their authors) with the text are different from the reviews without text:
...
### QQ-plot
```{r, text-review-distribution ,message=FALSE}
...
```{r, Word-cloud-for-base-game, warning=FALSE, message=FALSE}
set.seed(1)
#Base game
...
```{r, Word-cloud-for-the-DLC, warning=FALSE, message=FALSE}
set.seed(1)
#Base game
#Grouping up and counting
dlc_freq_pos %>%
...
```{r, Word-cloud-for-the-DLC2, warning=FALSE, message=FALSE}
set.seed(1)
#Base game
#Grouping up and counting
dlc2_freq_pos %>%
...
```{r, review_wordcounts, message=FALSE}
...
```{r, Tableau-export, message=FALSE, warning=FALSE}
